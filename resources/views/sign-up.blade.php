...
<section class="sign_up padding-top">
    <div class="container auto-container"> 
            ...
            <div class="row no-gutters justify-content-center">
                <div class="col-md-8">
                    <form class="label-form-style myform" action="{{ url('manual-register') }}" method="post">
                        @csrf
                        <div class="row no-gutters justify-content-center">
                            <div class="col-md-7">
                                <h5 class="pb-2 text-white">Sign Up</h5>
                                <div class="form-group">
                                    <label class="text-white">Name<span class="red-color">*</span></label>
                                    <input type="text" placeholder=" " class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') }}" required>
                                    <span class="sign_up_form_icon"><i class="las la-user"></i></span>
                                    @error('name')
                                        <small class="text-danger font-12">{{ $message }}</small>
                                    @enderror
                                </div>
                            </div>
                            <div class="col-md-7">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="password" value="" name="password" class="form-control @error('password') is-invalid @enderror" required>
